...
/**
 * {@snippet lang=c :
 * typedef uint32_t (*pRENDERDOC_GetOverlayBits)(void)
 * }
 */
public final class pRENDERDOC_GetOverlayBits {
    ...
    private static final MethodHandle UP$MH = renderdoc_app_h.upcallHandle(pRENDERDOC_GetOverlayBits.Function.class, "apply", $DESC);
